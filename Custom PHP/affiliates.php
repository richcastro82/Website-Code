...
add_action('init', 'techno_affiliates_sections');

if(!function_exists('techno_affiliates_sections')):

	function techno_affiliates_sections(){
...
// ========== blog Area
if(!function_exists('techno_affiliates_area')){
	function techno_affiliates_area( $atts , $content = null ){
	...
	switch ( $layout ) {
		...
		?>
			<div class=" blog_style_adn_2">
				<div class="blog_wrap affiliates_carousel owl-carousel curosel-style">
					...
					?>
						...
						<div class=" <?php if( $gutter == 'yes' ){echo 'blog_nospace_adn';}?>  col-md-12 col-xs-12 col-sm-12 " >
							<div class="single_affiliates <?php echo esc_attr( $extra_class ); ?>">


								<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									<div class="techno-single-affiliates ">

										<!-- BLOG THUMB -->
										<?php if(has_post_thumbnail()){?>
											<div class="affiliates-thumb ">
...
add_shortcode ('techno_affiliates', 'techno_affiliates_area' );
